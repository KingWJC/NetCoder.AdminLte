...
namespace NetCode.Util
{
    ...
    public static class GlobalSwitch
    {
        ...
        /// 项目名
        /// </summary>
        public static string ProjectName { get; } = "NetCode";
        ...
        /// 默认实体命名空间
        /// </summary>
        public static string DefaultEntityNamespace { get; } = "NetCode.Entity";
        ...
        /// 日志记录方式
        /// </summary>
        public static LoggerType LoggerType { get; set; } = LoggerType.File;
        ...
        public static long DatacenterId { get => ConfigHelper.GetAppSetValue("DatacenterId").ToString().ToLong(); }
        public static long WorkerId { get => ConfigHelper.GetAppSetValue("WorkerId").ToString().ToLong(); }
