...
namespace NetCode.Util
{
    ...
    public abstract class DbHelper
    {
        ...
        {
            _dbType = dbType;
            _conStr = DbObjectHelper.GetConStr(conStr);
        }
        ...
        /// <returns></returns>
        public abstract List<DbFieldInfo> GetDbFieldInfo(string tableName);
        ...
        public virtual void SaveEntityToFile(List<DbFieldInfo> infos, string tableName, string tableDescription, string filePath, string nameSpace, string schemaName = null)
        {
            string properties = "";
            string schema = "";
