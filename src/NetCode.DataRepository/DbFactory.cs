...
namespace NetCode.DataRepository
{
    ...
    public class DbFactory
    {
        ...
        public static IRepository GetRepository(string conString = null, DatabaseType? dbType = null, string entityNamespace = null)
        {
            ...
            conString = DbObjectHelper.GetConStr(conString);
            ...
            Type dbRepositoryType = Type.GetType("NetCode.DataRepository." + DbObjectHelper.DbTypeToDbTypeStr(dbType.Value) + "Repository");
