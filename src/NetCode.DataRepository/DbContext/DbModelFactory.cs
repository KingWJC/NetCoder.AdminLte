...
namespace NetCode.DataRepository
{
    public static class DbModelFactory
    {
        ...
        {
            var assemblies = AppDomain.CurrentDomain.GetAssemblies().Intersect(new Assembly[] { Assembly.Load("NetCode.Entity") });
        ...
        private static DbCompiledModelInfo BuildDbCompiledModelInfo(string nameOrConStr, DatabaseType dbType)
        {
            ...
            {
                DbConnection connection = DbObjectHelper.GetDbConnection(nameOrConStr, dbType);
