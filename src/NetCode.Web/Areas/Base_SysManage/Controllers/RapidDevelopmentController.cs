...
{
    public class RapidDevelopmentController : MvcBaseController
    {
        public RapidDevelopmentController
            (IMenuBusiness sysMenu, IOperator @operator, IRapidDevelopmentBusiness rapidDevBus)
